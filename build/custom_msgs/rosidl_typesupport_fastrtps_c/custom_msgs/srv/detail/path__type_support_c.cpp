...
#include "custom_msgs/srv/detail/path__rosidl_typesupport_fastrtps_c.h"
...
using _Path_Request__ros_msg_type = custom_msgs__srv__Path_Request;
...
size_t get_serialized_size_custom_msgs__srv__Path_Request(
  const void * untyped_ros_message,
...
static uint32_t _Path_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_msgs__srv__Path_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_msgs
size_t max_serialized_size_custom_msgs__srv__Path_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_msgs__srv__Path_Request;
    is_plain =
      (
...
static size_t _Path_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_msgs__srv__Path_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_msgs, srv, Path_Request)() {
...
using _Path_Response__ros_msg_type = custom_msgs__srv__Path_Response;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: path
  {
    ...
    if (ros_message->path.data) {
      rosidl_runtime_c__int64__Sequence__fini(&ros_message->path);
    }
    if (!rosidl_runtime_c__int64__Sequence__init(&ros_message->path, size)) {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_msgs
size_t get_serialized_size_custom_msgs__srv__Path_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Path_Response__ros_msg_type * ros_message = static_cast<const _Path_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_msgs__srv__Path_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_msgs
size_t max_serialized_size_custom_msgs__srv__Path_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = custom_msgs__srv__Path_Response;
    is_plain =
      (
...
static size_t _Path_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_msgs__srv__Path_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_msgs, srv, Path_Response)() {
...
// already included above
// #include "custom_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "custom_msgs/srv/path.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_msgs, srv, Path)() {
  return &Path__handle;
}
