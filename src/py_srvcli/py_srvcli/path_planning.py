...
class RRT:
    ...
    def __init__(self, start_point, end_point, stepsize , iterlimit, corners, image):

        self.nodeslist = []
        self.start_point = start_point
        self.end_point = end_point 

        self.obstacle_points = self.find_obstacle_points(corners)
...
if __name__ == "__main__":
    ...
    image = cv2.imread("/home/rishith/MRT/MRT_ASSIGNMENT_4/Aruco_tag_picture.png")
    ...
    rrt_planrer = RRT(start_point,end_point, step_size ,iter_limit ,obstacle_list,image)
